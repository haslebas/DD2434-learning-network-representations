...
def get_dataset(dataset_name):
    ...
    if dataset_name == "big_cora":
        ...
        #G = get_graph_from_pickle("../data/Cora-dataset/cora_graph_dir.gpickle", get_node_features=True)
    ...
    elif dataset_name == "dbpl-ci":
        G = get_graph_from_pickle("../data/DBLP-Ci-dataset/dblp-ci_graph_dir_lp.gpickle", get_node_features=True)
        # TODO
        #node_ids = get_node_ids("../data/DBLP-Ci-dataset/data/gr")
    elif dataset_name == "dbpl-au":
