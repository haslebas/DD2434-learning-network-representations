...
FILE=../embeddings/reddit_nc_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
    # Run DeepWalk on Reddit
    python main.py ../data/reddit/reddit_graph.gpickle ../embeddings/reddit_nc_deepwalk_128d -n_walks 2 -t 5 -w 5
fi

FILE=../embeddings/flickr_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
    # Run DeepWalk on Flickr
    python main.py ../data/Flickr-dataset/flickr_graph.gpickle ../embeddings/flickr_deepwalk_128d -n_walks 10 -t 20 -w 5
fi

FILE=../embeddings/youtube_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
...
FILE=../embeddings/youtube_lp_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
...
FILE=../embeddings/reddit_lp_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
...
FILE=../embeddings/dblp-au_lp_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
...
FILE=../embeddings/flicker_lp_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
...
FILE=../embeddings/twitter_dir_lp_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
    # LP DeepWalk for Twitter
    python main.py ../data/Twitter-dataset/twitter_graph_dir_lp.gpickle ../embeddings/twitter_dir_lp_deepwalk_128d -n_walks 10 -t 20 -w 5
fi
...
FILE=../embeddings/epinions_dir_lp_deepwalk_128d.pkl
if [ -f "$FILE" ]; then
    echo "$FILE exists."
else 
    echo "creating $FILE embeddings"
